        ...
        <div class="main-left-cell infinite-list-wrapper">
          ...
          >
            <div class="cell-left">
              ...
              ></div>
              <!-- <p>{{a.user.name}}</p> -->
              <p class="el-icon-thumb" style="margin-right: 5px">
                {{ a.thumb }}
              </p>
          ...
          <div class="loading-container">
            <p class="el-icon-loading" v-if="loading"></p>
      ...
      <div class="main-right">
        ...
        <div class="main-right-bottom">
          <ul>
            <li>
              <div>
                <a href="#" class="title">今日公告</a>
                <p>小程序发布于xxxx</p>
              </div>
              <a href="#" class="focus">敬请期待</a>
            </li>
            <li>
              <div>
                <a href="#" class="title">开发进程</a>
                <p>开发文档全公布</p>
              </div>
              <a href="#" class="focus">敬请期待</a>
            </li>
            ...
            <li>
              <!-- <a class="author-icon"
                   href="#"><img src="@/assets/wechat.png"
                       alt=""></a> -->
              <div>
                <a href="#" class="title">扫码下载蓝牙小程序</a>
                <p>蓝牙控制端小程序</p>
              </div>
              <a href="#" class="focus">关注我们</a>
            </li>
          </ul>
          <a href="#" class="main-right-bottom-footer"> 查看全部 </a>
        </div>
      </div>
    </section>
  </div>
...
export default {
  ...
  methods: {
    ...
    async loadAll() {
      ...
      console.log(res)
      if (res.status == 200) this.restaurants = res.data
