<template>
  ...
  >
	<el-avatar v-if="!editForm.avatar_url" icon="el-icon-user-solid"></el-avatar>
	<img v-else class="avatar-img" :src="editForm.avatar_url"></img>
</el-upload>
		...
		<el-card class="per-message">
				...
				<el-form 
						...
						<el-button v-show="!editable" type="primary" size="mini" @click="editable=true">编辑信息</el-button>
